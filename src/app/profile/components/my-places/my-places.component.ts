...
export class MyPlacesComponent implements OnInit {
  ...
  public async  onToChat(place: Place) {
    console.log('going to the chat ', place);
    await this.router.navigate(['/chat'], { queryParams: { placeId: place.id, placeName: place.name } });
